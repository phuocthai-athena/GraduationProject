...
let initWebRoutes = (app) => {
  ...
  router.get(
    "/api/get-list-history-patient",
    userController.getListHistoryPatient
  );
  router.post("/api/forgot-password", userController.handleForgotPassword);
  router.post(
    "/api/verify-reset-password",
    userController.handleVerifyResetPassword
  );
  ...
  router.delete(
    "/api/delete-clinic-by-id/:clinicId",
  ...
  router.delete(
    "/api/delete-handbook-by-id/:handBookId",
    handbookController.deleteHandBookById
  );
  router.put(
    "/api/update-handbook-by-id",
    handbookController.updateHandBookById
  );
